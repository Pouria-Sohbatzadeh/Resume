...
export default function Recommended_Vabinar() {
  ...
  return (
    <>
      <section className="flex flex-col gap-[20px] lg:mt-[90px] ">
        <Headline_SeeMore headlineTxt="وبینارهای پیشنهادی" seeMoreTxt="" />

        {/* All the boxes */}
        <div
          className="relative flex flex-row items-center lg:gap-[20px] 
        overflow-auto pb-[30px] custom-scrollbar"
          {...events}
